...
class FeatureSection2 extends AppStatelessComponent {
  ...
  Component _buildTopContent() {
    return div(
      ...
      [
        div(
          classes: 'mx-auto max-w-2xl sm:text-center',
          [
            h2(
  ...
  Component _buildAppScreenshotImage() {
    return div(
      classes: 'relative overflow-hidden pt-16',
      [
        div(
          classes: 'mx-auto max-w-7xl px-6 lg:px-8',
          [
            img(
              classes: 'mb-[-12%] rounded-xl shadow-2xl ring-1 ring-white/10',
              src:
